...
| 
image::../../sources/images/common_folder.png[width="50"]
2+| 　
...
image::../../sources/images/common_folder.png[width="50"]
| area
| 区域モデルを格納するフォルダ。拡張製品仕様書に追加した地物のうち、Zoneを継承する地物を含む。（UnclassifiedBlankarea（非線引き用途白地）、UnclassifiedUseDistrict（非線引き用途地域））を含む。
...
image::../../sources/images/common_folder.png[width="50"]
| ext
| 拡張製品仕様書で追加した地物（ただし、Zoneを継承する地物は除く）を格納するフォルダ。
