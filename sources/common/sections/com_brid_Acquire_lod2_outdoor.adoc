...
h| 取得例
^.^|
image::../../sources/images/brid_Acquire_lod20_out_01.png[]
2+^.^|
image::../../sources/images/brid_Acquire_lod20_out_02.png[]
...
h| 取得例
^.^|
image::../../sources/images/brid_Acquire_lod21_out_01.png[]
^.^|
image::../../sources/images/brid_Acquire_lod21_out_02.png[]
^.^|
image::../../sources/images/brid_Acquire_lod21_out_03.png[]
