...
本附属書では、「3D都市モデル標準製品仕様書」（以下、「標準製品仕様書」という）に適合したデータ製品について、「建築物モデル」に従って作成されるべき都市オブジェクト（以下、「建築物オブジェクト」という）が満たすべき要件を示す。
...
requirement:: /req/bldg/33
requirement:: /req/bldg/34
